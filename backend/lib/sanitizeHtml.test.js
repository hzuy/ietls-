...
// Stored-XSS guard for WritingSample / SpeakingSample rich-text content.
// Mirrors the frontend suite (frontend/src/utils/sanitizeHtml.test.js).
...
describe('sanitizeRichText — null / empty handling', () => {
  it('returns null for null / undefined (backend column is nullable)', () => {
