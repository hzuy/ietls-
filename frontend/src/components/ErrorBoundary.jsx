...
export default class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-zinc-50/50 flex flex-col items-center justify-center p-6 text-center font-sans">
          <div className="bg-white p-8 sm:p-10 rounded-xl border border-zinc-200 shadow-xs max-w-md w-full">
            <div className="w-14 h-14 rounded-full bg-rose-50 border border-rose-200 flex items-center justify-center text-rose-600 mx-auto mb-6">
