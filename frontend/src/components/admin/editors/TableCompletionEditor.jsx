 ...
 * Bản kia: src/components/practice/TableCompletionEditor.jsx
...
import { inputCls, labelCls, getQuestionGroupTheme } from '../adminConstants'
    ...
    <div className="space-y-3">
      ...
      <div className={`${theme.subBoxBg} border ${theme.subBoxBorder} rounded-xl p-4`}>
                    ...
                    <td className="border border-gray-200 px-1 text-center align-middle">
                      {dataLines.length > 1 && (
                        <button type="button" onClick={() => removeRow(ri)}
                          className="text-red-500 hover:text-red-600 text-xs">✕</button>
                      )}
                    </td>
                  </tr>
                )
        ...
        <button type="button" onClick={addRow}
          className={`mt-2 text-xs ${theme.subBoxText} font-semibold hover:underline`}>+ Thêm hàng</button>
      </div>
