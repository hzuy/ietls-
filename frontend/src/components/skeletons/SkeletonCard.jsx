...
export default function SkeletonCard({ count, className = '', aspect = '16/9' }) {
  ...
  const renderCard = (key) => (
    ...
    >
      {/* Thumbnail */}
      <div className={`w-full bg-zinc-200 animate-pulse shrink-0 ${aspectClass}`} />
      ...
      <div className="p-4 flex flex-col flex-1 gap-3">
        ...
        <div className="h-4 bg-zinc-200 animate-pulse rounded w-[55%] mt-auto" />
        <div className="h-9 bg-zinc-200 animate-pulse rounded-xl mt-2" />
      </div>
    </div>
  )
