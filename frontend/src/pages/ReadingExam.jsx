...
export default function ReadingExam() {
  ...
  // Auto-save draft every 30 seconds during exam
  useEffect(() => {
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
          {previewMode ? (
            <button
              ...
              style={{ fontFamily: 'var(--font-body)', fontSize: 12, padding: '4px 12px', borderRadius: 99, fontWeight: 600, border: 'none', cursor: 'pointer', background: showAnswers ? 'var(--skill-l-color)' : 'rgba(255,255,255,0.12)', color: showAnswers ? 'white' : 'rgba(255,255,255,0.7)' }}
            >
