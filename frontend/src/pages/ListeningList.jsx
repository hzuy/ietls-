...
import { getListeningExams } from '../services/examService'
...
export default function ListeningList() {
  ...
  const handleStart = (exam) => {
    ...
    setTimeout(() => navigate(`/listening/${exam.id}`), 350)
  }
      ...
      <div style={{ backgroundColor: 'white', borderBottom: '1px solid #e2e8f0' }}>
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-extrabold" style={{ color: '#1e3a5f' }}>Listening</h1>
              <p className="text-xs" style={{ color: '#64748b' }}>4 phần · 40 câu hỏi · 30 phút</p>
            </div>
          </div>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl p-12 text-center" style={{ backgroundColor: 'white', border: '1px solid #e2e8f0' }}>
            ...
            <p className="text-sm mt-1" style={{ color: '#64748b' }}>Admin chưa thêm đề Listening</p>
          </div>
        ) : (
